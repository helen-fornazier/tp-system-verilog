if { ![project_exists {div_ieee}] } {
     project_new {div_ieee}
} else {
     project_open {div_ieee}
}
set_project_settings -cmp {div_ieee}
if { ![project_settings_exist -sim div_ieee] } {
        set_project_settings -sim div_ieee
}
set_global_assignment -section_id {div_ieee} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {VQM_FILE} {div_ieee.vqm}
...
if { [file exists {div_ieee_altera.prop}] } {
  source div_ieee_altera.prop
}
set_global_assignment -name {FAMILY} {CYCLONE II}
set_global_assignment -section_id {div_ieee} -name {DEVICE} {EP2C35F672C6}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {div_ieee_pnr_constraints.sdc}
