if { ![project_exists {mult_ieee}] } {
     project_new {mult_ieee}
} else {
     project_open {mult_ieee}
}
set_project_settings -cmp {mult_ieee}
if { ![project_settings_exist -sim mult_ieee] } {
        set_project_settings -sim mult_ieee
}
set_global_assignment -section_id {mult_ieee} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {VQM_FILE} {mult_ieee.vqm}
...
if { [file exists {mult_ieee_altera.prop}] } {
  source mult_ieee_altera.prop
}
set_global_assignment -name {FAMILY} {CYCLONE II}
set_global_assignment -section_id {mult_ieee} -name {DEVICE} {EP2C35F672C6}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {mult_ieee_pnr_constraints.sdc}
