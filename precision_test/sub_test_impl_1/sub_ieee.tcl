if { ![project_exists {sub_ieee}] } {
     project_new {sub_ieee}
} else {
     project_open {sub_ieee}
}
set_project_settings -cmp {sub_ieee}
if { ![project_settings_exist -sim sub_ieee] } {
        set_project_settings -sim sub_ieee
}
set_global_assignment -section_id {sub_ieee} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {VQM_FILE} {sub_ieee.vqm}
...
if { [file exists {sub_ieee_altera.prop}] } {
  source sub_ieee_altera.prop
}
set_global_assignment -name {FAMILY} {CYCLONE II}
set_global_assignment -section_id {sub_ieee} -name {DEVICE} {EP2C35F672C6}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {sub_ieee_pnr_constraints.sdc}
